# CREATE_MAZE FUNCTION (and tutorial) FROM https://github.com/OrWestSide/python-scripts/blob/master/maze.py
...
maze[starting_height][starting_width] = "S"
